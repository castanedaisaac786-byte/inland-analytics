...
def report():
    ...
    print("\n[7] LIMITATIONS")
    print("    - The 5 benchmark bookings are RECALLED, not logged. The entire")
    print("      $26.09 threshold rests on an unverified number. Fixing the job log")
    print("      is higher priority than any further ad spend.")
